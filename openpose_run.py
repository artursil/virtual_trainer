...
parser.add_argument('--start',default=0,type=int, help='Starting point for a dataloader')
...
parser.add_argument('--path-to-save',default='default', help='Print time per image')
