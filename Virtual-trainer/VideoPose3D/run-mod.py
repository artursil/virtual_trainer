...
# --- run-mod.py ---
# modified run script for fine tuning pretrained model with fewer layers [3,3,3,3,3] -> [3,3,3]
#
...
pretrained_filename = os.path.join('pretrained', 'pretrained_h36m_cpn.bin')
...
pretrained_mod = TemporalModelOptimized1f(17,2,17,filter_widths=[3,3,3,3,3],causal=args.causal,dropout=args.dropout, channels=args.channels)
pretrained_checkpoint = torch.load(pretrained_filename, map_location=lambda storage, loc: storage)
pretrained_mod.load_state_dict(pretrained_checkpoint['model_pos'])
...
model_pos_train.shrink.weight.data = pretrained_mod.shrink.weight.data
model_pos_train.expand_conv.weight.data = pretrained_mod.expand_conv.weight.data
model_pos_train.layers_conv[0].weight.data = pretrained_mod.layers_conv[2].weight.data
model_pos_train.layers_conv[1].weight.data = pretrained_mod.layers_conv[3].weight.data
model_pos_train.layers_conv[2].weight.data = pretrained_mod.layers_conv[6].weight.data
model_pos_train.layers_conv[3].weight.data = pretrained_mod.layers_conv[7].weight.data
