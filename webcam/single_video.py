import sys
sys.path.insert(0, "/home/artursil/Documents/virtual_trainer")
sys.path.insert(0,
        "/home/artursil/Documents/virtual_trainer/Virtual_trainer")
...
def openpose_main(model):
    ...
    with torch.no_grad():
        ...
        while True:
            ...
            df_dict =  {"vid_nr":ix,"filename":url, "clip_id":0, "target":0, 
    ...
    with torch.no_grad():
        ...
        try:
            ...
            raise ValueError('clip_df is empty because openpose hasnt detected a person')
